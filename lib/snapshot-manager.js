...
const resolveSourceFile = mem(file => {
	...
	// since Node.js 18.8.0, the return value of `findSourceMap` changed to null if not found
	// it was `undefined` in previous version
	// https://github.com/nodejs/node/pull/43875
