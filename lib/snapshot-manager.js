...
class Manager {
	...
	save() {
		if (this.newBlocksByTitle.size === 0) {
			return [
				...cleanFile(path.join(this.dir, this.snapFile)),
				...cleanFile(path.join(this.dir, this.reportFile))
			];
		}
...
function load({file, fixedLocation, projectDir, recordNewSnapshots, updating}) {
	...
	paths.snapPath = path.join(paths.dir, paths.snapFile);
