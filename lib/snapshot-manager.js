...
function combineEntries(blocksByTitle) {
	...
	const sortedBlocks = sortBlocksByTitle(blocksByTitle);
...
function sortBlocksByTitle(blocksByTitle) {
	...
	for (const entry of blocksByTitle.entries()) {
	...
	indexed.sort(([, a], [, b]) => a.taskIndex - b.taskIndex);
	return new Map([...indexed, ...unindexed]);
}
...
class Manager {
	...
	save() {
		...
		const reportBuffer = generateReport(this.relFile, this.snapFile, this.newBlocksByTitle);
