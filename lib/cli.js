...
exports.run = async () => { // eslint-disable-line complexity
	...
	const Reporter = (combined.tap && !combined.watch && debug === null) ? TapReporter : DefaultReporter;
	...
	const reporter = new Reporter({
		...
		mode: (debug !== null || combined.verbose || isCi || !process.stdout.isTTY) ? 'verbose' : 'mini'
	});
