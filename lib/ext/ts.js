...
try {
	...
	console.log('AVA error: `--extensions ts` require typescript installed. Please run `npm install typescript` first.');
	throw err;
}
var tsnode; // = require('ts-node'); XXX: maybe useful in the future, because tsnode do more than typescritp for our case.
