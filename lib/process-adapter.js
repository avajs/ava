...
module.exports.on = process.on.bind(process);
module.exports.emit = process.emit.bind(process);
module.exports.exit = process.exit.bind(process);
module.exports.env = process.env;

var opts = module.exports.opts = JSON.parse(process.argv[2]);
...
module.exports.installSourceMapSupport = function () {
...
module.exports.installPrecompilerHook = function () {
...
module.exports.installDependencyTracking = function (dependencies, testPath) {
...
module.exports.startTests = function () {
	console.log('Do not use processAdapter.startTests() in Node. Only browsers');
};
