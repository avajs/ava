...
function CachingPrecompiler(cacheDirPath, babelConfig, disablePowerAssert) {
	...
	this.disablePowerAssert = disablePowerAssert;
...
CachingPrecompiler.prototype._transform = function (code, filePath, hash) {
	...
	var options = babelConfigHelper.build(this.babelConfig, this.disablePowerAssert, filePath, code);
