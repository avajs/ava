...
function Watcher(logger, api, patterns, sources) {
	this.debouncer = new Debouncer(this);
	this.avaFiles = new AvaFiles(patterns, sources);
	...
	this.run = function (specificFiles) {
		...
		var files = new AvaFiles(specificFiles || patterns)
			.findTestFilesSync();

		this.busy = api.run(files, {
