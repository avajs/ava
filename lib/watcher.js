...
const promiseWithResolvers = Promise.withResolvers?.bind(Promise) ?? (() => { // eslint-disable-line n/no-unsupported-features/es-syntax, no-use-extend-native/no-use-extend-native
	let resolve;
	let reject;
