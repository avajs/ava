...
function revertGlobal() {
	const storedKeys = {};
	const storedCache = {...require.cache};
	const storedExtensions = {...module.constructor._extensions};
	const preventCache = ['../index.js', './worker/main.js'];
	...
	return () => {
		...
		module.constructor._cache = {...storedCache};
		module.constructor._extensions = {...storedExtensions};
