...
function validate(conf) {
	...
	invalid = !conf || typeof conf !== 'object' || !conf.testOptions || typeof conf.testOptions !== 'object' || Array.isArray(conf.testOptions);
	invalid = !validateKeys(conf) || (conf.extensions && !Array.isArray(conf.extensions));
