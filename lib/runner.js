...
function addFn(Constructor, defaultOpts) {
	return function (title, fn) {
		this._addTest(Constructor, title, fn, objectAssign({}, defaultOpts));
	};
}

Runner.prototype.addTest = addFn(Test, {});
Runner.prototype.addSerialTest = addFn(Test, {serial: true});
Runner.prototype.addBeforeHook = addFn(Test, {type: 'before'});
Runner.prototype.addAfterHook = addFn(Test, {type: 'after'});
Runner.prototype.addSkippedTest = addFn(Test, {skipped: true});
Runner.prototype.addOnlyTest = addFn(Test, {exclusive: true});
Runner.prototype.addBeforeEachHook = addFn(Hook, {type: 'beforeEach'});
Runner.prototype.addAfterEachHook = addFn(Hook, {type: 'afterEach'});
