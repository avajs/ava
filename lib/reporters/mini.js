...
function MiniReporter() {
	...
	this.spinnerFrames = spinnerDef.frames;
...
MiniReporter.prototype.start = function () {
	...
	this.interval = setInterval(function () {
		self.spinnerFrame = (self.spinnerFrame + 1) % self.spinnerFrames.length;
		self.write(self.spinnerChar() + self.currentTest);
	}, this.spinnerInterval);
	return this.spinnerChar();
};
...
MiniReporter.prototype.test = function (test) {
	this.currentTest = this._test(test);
	return this.spinnerChar() + this.currentTest;
};
