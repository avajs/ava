...
class VerboseReporter {
	...
	addTestRunning(evt) {
		...
		this.runningTestFiles[evt.testFile][evt.title] = true;
	}

	removeTestRunning(evt) {
		this.runningTestsCount--;
		delete this.runningTestFiles[evt.testFile][evt.title];
	}
	...
	runningTestSummary() {
		...
		Object.keys(this.runningTestFiles).forEach(file => {
			Object.keys(this.runningTestFiles[file]).forEach(test => {
