...
AvaFiles.prototype.makeSourceMatcher = function makeSourceMatcher() {
	var mixedPatterns = [];
...
AvaFiles.prototype.makeTestMatcher = function makeTestMatcher() {
...
AvaFiles.prototype.getChokidarPatterns = function getChokidarPatterns() {
	var paths = [];
	var ignored = [];
