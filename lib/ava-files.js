...
AvaFiles.prototype.findTestFilesSync = function () {
	return handlePathsSync(this.files, this.excludePatterns, {
		cache: Object.create(null),
		statCache: Object.create(null),
		realpathCache: Object.create(null),
		symlinks: Object.create(null)
...
function handlePathsSync(files, excludePatterns, globOptions) {
	files = globby.sync(files.concat(excludePatterns), globOptions);
	...
	var result = files
		.map(function (file) {
			if (fs.statSync(file).isDirectory()) {
				...
				return handlePathsSync([pattern], excludePatterns, globOptions);
			}
